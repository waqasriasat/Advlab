...
namespace AdvLab_WebApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            .FirstOrDefaultAsync(u => u.EmpId == id);
            if (User == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int EmpId, [Bind("Id,LoginStatus,LoginStatusIp,LoginStatusComp,Nsend,RegDate,EmpId,Uname,Upassword,ClientV,Status,Place,PlaceCategory,Cnl,Location,Depart,SubDepart,Placement,Designation,Uid,Idloc,CompMac,PayGenerate,RoleId,Token")] User editedUser)
        {
